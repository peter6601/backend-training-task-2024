...
const weightTrainingOneOnOneSession = 1500;
...
let x = 1, y = 1, z = 1;
const totalPrice =  weightTrainingGroupClass * x + yogaGroupClass * 3 * y + weightTrainingOneOnOneSession * z;
let AlexBudget = 0;

if  (totalPrice > 2400 && totalPrice < 3000 &&  (x + 3 * y + z) == 5) {
  AlexBudget = alexMonthlyExerciseBudget - totalPrice;
};
...
const planTitle = "14 堂組合包方案";
const planPrice = 2520;
const planeContentArray = ["包含14 堂課，一堂50分鐘","平均每堂價格：180元","9折"];
...
//ANS: [5, 10, 15] [25, 30, 35]
//arr2複製arr1的值，arr2新增值20, arr2被宣告為[25,30,35]

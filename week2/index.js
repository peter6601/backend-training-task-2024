...
} else if (coachIncome >= 10 && coachIncome < 300000 ){
...
const gymCoach = {
  coaches: [
    ...
    backgrounDescription: "王教練擁有 5 年教學經驗，專精於提升學員的肌力與減脂，適合希望快速達成體能目標的學員。",
    ...
    backgrounDescription: "李教練是一位瑜伽大師，擁有 10 年教學經驗，擅長幫助學員雕塑完美體態，適合希望改善姿態與柔軟度的學員。",
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += activities.bicycle.caloriePerMins * 10;
calorieBurn += activities.treadmill.caloriePerMins * 30;
calorieBurn += activities.yoga.caloriePerMins * 40;
calorieBurn += activities.bicycle.caloriePerMins * 10;
...
for (let i = 2; i <= 4; i++) {
  if (exerciseRecords[i].duration >= 30 && 
    exerciseRecords[i].heartRate >= 130) {
